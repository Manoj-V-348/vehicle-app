...
const generateMockVehicles = (): Vehicle[] => {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    vehicles.push({
      ...
      year,
      type: 'Car',
      condition: ['New', 'Used', 'Certified Pre-Owned'][Math.floor(Math.random() * 3)] as any,
      price: 30000 + Math.floor(Math.random() * 120000),
      rentalPricePerDay: 100 + Math.floor(Math.random() * 400),
      fuelType: ['Petrol', 'Diesel', 'Electric', 'Hybrid'][Math.floor(Math.random() * 4)] as any,
      transmission: ['Automatic', 'Manual', 'CVT'][Math.floor(Math.random() * 3)] as any,
  ...
  for (let i = 0; i < 8; i++) {
    ...
    vehicles.push({
      ...
      transmission: ['Automatic', 'Semi-Automatic'][Math.floor(Math.random() * 2)] as any,
  ...
  for (let i = 0; i < 6; i++) {
    ...
    vehicles.push({
      ...
      condition: ['New', 'Used'][Math.floor(Math.random() * 2)] as any,
  ...
  for (let i = 0; i < 4; i++) {
    ...
    vehicles.push({
      ...
      fuelType: ['Petrol', 'Diesel'][Math.floor(Math.random() * 2)] as any,
